...
import { HomeIcon, UserIcon, FolderIcon, BriefcaseIcon, FileTextIcon, MailIcon, Instagram } from "lucide-react"
  ...
  return (
    <div className='flex flex-col'>
        <div>
            ...
            <h1 className='text-3xl font-bold text-left md:text-5xl md:pt-20 py-3 pl-3'>Abdul <br className='hidden md:block'/>Moeez <br className='hidden md:block'/>Shaikh</h1>
        </div>
        <div className="h-full flex items-end justify-start">
            <div className=" w-full md:py-28 md:w-auto">
                <RadioGroup 
                value={activeSection}
        ...
        <div className="flex-col items-center justify-center hidden md:flex">
            <div className="flex items-center justify-center">
                <Link href="https://instagram.com/abdul_moeez_shaikh" target="_blank" className="p-2 rounded-md hover:bg-muted/80 transition-colors">
                    <Instagram size={40} className="hover:text-primary" />
                </Link>
                
            </div>
            <p className="text-sm text-muted-foreground">© 2025 Moeez</p>
        </div>
    </div>
  )
}
